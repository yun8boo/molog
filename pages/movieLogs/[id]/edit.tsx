  ...
  return (
    <div className='flex flex-col items-center p-6'>
      ...
      <div className="mb-4">
        ...
        <input type="submit" className='transition cursor-pointer shadow bg-purple-500 hover:bg-purple-700 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded' />
      </form>
    </div>
  )
}
